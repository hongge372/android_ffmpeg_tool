...
static int open_output_file(OptionsContext *o, const char *filename)
{
    ...
    av_log(NULL, AV_LOG_DEBUG, "get time flg for break, o->recording_time: %lld o->stop_time: %lld \n",  o->recording_time, o->stop_time);
    ...
    if (o->recording_time != INT64_MAX){
        ...
        av_log(NULL, AV_LOG_DEBUG, "get time flg for break,(o->recording_time) is int64_max \n");
    }
        
    av_log(NULL, AV_LOG_ERROR, "set duration:%lld recording_time:%lld  ",  oc->duration, o->recording_time);
